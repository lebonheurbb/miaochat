export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0B1120] to-[#0A0F1C] text-white">
      {/* 导航栏 */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="/register" className="px-4 py-2 rounded-full bg-[#00AAFF] hover:bg-[#0099FF] text-white">
                注册
              </a>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <a
              href="/chat"
              className="px-8 py-3 text-lg font-medium rounded-full bg-gradient-to-r from-[#0066FF] to-[#00AAFF] hover:from-[#0066FF]/90 hover:to-[#00AAFF]/90 transition-all duration-200"
            >
              开始对话
            </a>
            <a
              href="/about"
              className="px-8 py-3 text-lg font-medium rounded-full border border-[#1E293B] hover:border-[#0066FF] hover:text-[#0066FF] transition-colors"
            >
              了解更多
            </a>
          </div>
